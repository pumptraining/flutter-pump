...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    animationsMap.forEach((key, animationInfo) {
      animationInfo.controller = AnimationController(
        vsync:
            this, // Certifique-se de que seu widget tenha TickerProviderStateMixin
    ...
    _model.controller = AnimationController(
      duration: Duration(milliseconds: 300),
      vsync: this, // Aqui você usa o TickerProvider fornecido pelo mixin.
    );
  ...
  void dispose() {
    animationsMap.forEach((key, animationInfo) {
      animationInfo.controller.stop();
      animationInfo.controller.dispose();
    });
                                  ...
                                  children: [
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (_model.passwordController.text
                                            ...
                                            ScaffoldMessenger.of(context)
                                              ...
                                              SnackBar(
                                                content: Text(
                                                  'Adicione uma senha para criar a sua conta.',
                                                ),
                                              ),
                                            );
                                            return;
                                          ...
                                          logFirebaseEvent(
                                              'LOGIN_CONTINUE_COM_EMAIL_BTN_ON_TAP');
                                    ...
                                    Visibility(
                                      visible: FirebaseRemoteConfig.instance
                                              .getBool(
                                                  'apple_signin_button_enabled') ||
                                          FirebaseRemoteConfig.instance.getBool(
                                              'google_signin_button_enabled'),
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            16.0, 0.0, 16.0, 16.0),
                                        child: Text(
