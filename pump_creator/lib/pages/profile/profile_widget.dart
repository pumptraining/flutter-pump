...
class _ProfileWidgetState extends State<ProfileWidget> {
  ...
  Future<ApiCallResponse>? _loadContent() async {
    ...
    ApiCallResponse response = await BaseGroup.personalDetailsCall.call();
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Visibility(
                                  visible: currentUserPhoto.isNotEmpty ||
                                      (_model.content != null &&
                                          _model.content['personalImageUrl']
                                                  ?.isNotEmpty ==
                                              true),
                                  child: Padding(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'PROFILE_PAGE_Container_iumjk899_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context
                                .pushNamed('FaqScreenWidget', queryParameters: {
                              'questions': serializeParam(
                                  _model.getFAQOptions(), ParamType.JSON, true)
                            });
                          },
                          child: Container(
                            width: double.infinity,
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            var iosUrl =
                                "https://wa.me/$contact?text=${Uri.parse('Olá, sou $name, Personal Trainer, preciso de ajuda com o Pump App.')}";
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'PROFILE_PAGE_DELETE_ACCOUNT_ON_TAP');
                            logFirebaseEvent('Container_navigate_to');
                            ...
                            await showAlignedDialog(
                              ...
                              (value) async {
                                if (value == 'leave') {
                                  final result =
                                      await BaseGroup.deleteAccountCall.call();
                                  ...
                                  return Material(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: InformationDialogWidget(
                                        title: 'Atenção',
                                        message:
                                            'Tem certeza de que deseja cancelar a sua assinatura PRO?',
                                        actionButtonTitle: 'Cancelar',
                                      ),
                                    ),
                                  );
                                },
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(0, 44, 0, 44),
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
