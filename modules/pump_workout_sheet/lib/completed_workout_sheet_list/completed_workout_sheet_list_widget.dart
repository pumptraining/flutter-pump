...
import 'completed_workout_sheet_list_model.dart';
export 'completed_workout_sheet_list_model.dart';

class CompletedWorkoutSheetListWidget extends StatefulWidget {
  const CompletedWorkoutSheetListWidget(
      {Key? key, this.customerId, this.isPersonal})
      : super(key: key);
  ...
  @override
  _CompletedWorkoutSheetListWidgetState createState() =>
      _CompletedWorkoutSheetListWidgetState();
}

class _CompletedWorkoutSheetListWidgetState
    extends State<CompletedWorkoutSheetListWidget>
    with TickerProviderStateMixin {
  late CompletedWorkoutSheetListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompletedWorkoutSheetListModel());
  ...
  Future<ApiCallResponse>? _loadContent() async {
    ...
    ApiCallResponse response = await PumpGroup.userWorkoutSheetCompletedCall
        .call(params: {'customerId': widget.customerId});
                                    ...
                                    child: Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: CachedNetworkImage(
                                          ...
                                          fadeOutDuration:
                                              Duration(milliseconds: 500),
                                          imageUrl: workoutSheet['personal']
                                              ['imageUrl'],
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      _model.mapStatus(workoutSheet['status']),
                                      textAlign: TextAlign.end,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                                            fontFamily: 'Outfit',
                                            color: _model.mapStatusColor(
                                                workoutSheet['status'],
                                                context),
                                          ),
                                    ),
